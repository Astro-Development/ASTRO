...
module.exports = {
  ...
  run: async(client, message, args)=>{
    ...
    .setTitle("ASTRO BOT PRIVACY POLICY")
    .setThumbnail(icon)
    ...
    > If you have any concerns or queries relating our privacy policy or our bot or if you want your data to be removed, You can contact [Nate's World#6340](https://discord.com/users/752984675168944228) directy on our [Support Server]()!`)
